/*************************************************************************
    > File Name: SyntheticGameEngine_Effect.h
    > Author: Jintao Yang
    > Mail: 18608842770@163.com 
    > Created Time: Tue Nov 29 10:37:21 2022
 ************************************************************************/
...
#ifndef _SYNTHETIC_GAME_ENGINE_EFFECT_
#define _SYNTHETIC_GAME_ENGINE_EFFECT_

#ifdef _SYNTHETIC_GAME_ENGINE_

inline void SYNTHETIC_GAME::SyntheticGameEngine::SGESetProp(b2Body* body)
{
...
inline void SYNTHETIC_GAME::SyntheticGameEngine::SGEFreeProp(b2Body* body)
{
	BodyInfo* info = (BodyInfo*)(body->GetUserData().pointer);
...
inline void SYNTHETIC_GAME::SyntheticGameEngine::SGEClearProp()
{
...
inline void SYNTHETIC_GAME::SyntheticGameEngine::SGEFlash(float fElapsedTime)
{
	bool flag = true;
...
inline void SYNTHETIC_GAME::SyntheticGameEngine::SGEQuickMove(float fElapsedTime)
{
...
inline void SYNTHETIC_GAME::SyntheticGameEngine::SGESetStretch(b2Body* body)
{
	BodyInfo* info = (BodyInfo*)(body->GetUserData().pointer);
...
inline void SYNTHETIC_GAME::SyntheticGameEngine::SGEDeleteStretch(b2Body* body)
{
...
inline void SYNTHETIC_GAME::SyntheticGameEngine::SGEStretch(float fElapsedTime)
{
	Vector<int32_t> clear_list;
	int32_t _index_ = -1;
...
inline void SYNTHETIC_GAME::SyntheticGameEngine::SGESetSEffect(float sge_x_, float sge_y_, int32_t level)
{
...
inline void SYNTHETIC_GAME::SyntheticGameEngine::SGEDrawSEffect()
{
...
inline void SYNTHETIC_GAME::SyntheticGameEngine::SGEEffect(float fElapsedTime)
{
	Vector<int32_t> clear_list;
	int32_t _index_ = -1;
...
inline void SYNTHETIC_GAME::SyntheticGameEngine::SGESetSuccess(int32_t level)
{
	if (level < 0 || level >= BallTypeNum)
		return;
...
inline void SYNTHETIC_GAME::SyntheticGameEngine::SGESuccess(float fElapsedTime)
{
