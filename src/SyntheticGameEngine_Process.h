/*************************************************************************
    > File Name: SyntheticGameEngine_Process.h
    > Author: Jintao Yang
    > Mail: 18608842770@163.com 
    > Created Time: Tue Nov 29 10:33:11 2022
 ************************************************************************/
...
#ifndef _SYNTHETIC_GAME_ENGINE_PROCESS_
#define _SYNTHETIC_GAME_ENGINE_PROCESS_

#ifdef _SYNTHETIC_GAME_ENGINE_

bool SYNTHETIC_GAME::SyntheticGameEngine::DeadJudge()
{
...
void SYNTHETIC_GAME::SyntheticGameEngine::DeadFlash()
{
	b2Body* body = m_world->GetBodyList();
	int32_t body_num = m_world->GetBodyCount();
...
void SYNTHETIC_GAME::SyntheticGameEngine::DeadBomb()
{
	b2Body* body = m_world->GetBodyList();
	int32_t body_num = m_world->GetBodyCount();
...
int SYNTHETIC_GAME::SyntheticGameEngine::FindFixture(b2Fixture* _find_)
{
	int _index_ = -1;
...
inline bool SYNTHETIC_GAME::SyntheticGameEngine::NotBeDestroy(b2Body* body)
{
...
inline void SYNTHETIC_GAME::SyntheticGameEngine::PreSyntheticOperation(b2Body* body1, b2Body* body2, int32_t level)
{
...
inline void SYNTHETIC_GAME::SyntheticGameEngine::SyntheticOperation()
{
	size_t _size_ = 0;
...
inline void SYNTHETIC_GAME::SyntheticGameEngine::PropEvent(float fElapsedTime)
{
	if (!prop_body.empty())
	{
